...
// This file contains the implementations of the sqlDAL and sqlDALParameterCache
// classes.
    ...
    internal sealed class SqlHelper
    {
        ...
        private static void PrepareCommand(SqlCommand command, SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, SqlParameter[] commandParameters, out bool mustCloseConnection)
        {
            ...
            if (ConfigurationManager.AppSettings["CommandTimeOut"] == null)
                ...
                command.CommandTimeout = int.Parse(ConfigurationManager.AppSettings["CommandTimeOut"]);
        ...
        internal static DataSet ExecuteDataset(string connectionString, string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                SqlParameter[] commandParameters = sqlDALParameterCache.GetSpParameterSet(connectionString, spName, true); // Added Parameter true to support ReturnValues
